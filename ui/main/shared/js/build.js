var Build = (function() {
    ...
    var HotkeyModel = function() {
        ...
        self.updateTankName = function() {
          switch (api.settings.isSet('ui', 'tank_light_laser_is', true)) {
            case 'Ant':
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_light_laser.json"]
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_bolo.json"]
              self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_ant.json"] = ["vehicle", 13]
              break
            case 'Bolo':
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_ant.json"]
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_light_laser.json"]
              self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_bolo.json"] = ["vehicle", 13]
              break
            default: 
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_ant.json"]
              delete self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_bolo.json"]
              self.SpecIdToGridMap()["/pa/units/land/tank_light_laser/tank_light_laser.json"] = ["vehicle", 13]
              break
          }
        }
        self.updateTankName()
